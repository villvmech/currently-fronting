...
const Home: NextPage = () => {
  ...
  return (
    <div className='flex flex-col justify-between min-h-screen'>
      ...
      {/* prettier-ignore */}
      <footer className='container mx-auto mb-2 max-w-md md:max-w-4xl p-2 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-50 text-center rounded'>
